...
public interface Nozzle
    ...
    //************--------------*************//
    // MODIFICATION OF NOZZLE CLASS STARTS HERE 
    //************--------------*************//
    ...
    /**
     * Get the specific up-looking camera associated with this nozzle.
     * If no camera is set, this can return null, in which case a fallback to a default camera can be handled elsewhere.
     * 
     * @return The specific up-looking camera for this nozzle.
     */
    Camera getCamera();
    
    /**
     * Set a specific up-looking camera to this nozzle.
     * 
     * @param camera The camera to be associated with this nozzle.
     */
