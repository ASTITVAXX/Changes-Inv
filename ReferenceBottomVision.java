...
public class ReferenceBottomVision extends AbstractPartAlignment {
    ...
    //************--------------*************//
    // MODIFICATION OF offsets CLASS STARTS HERE 
    //************--------------*************//



    /* To address the 4th change — modifying ReferenceBottomVision.findOffsets to reference the updated getBottomVisionCamera method with the optional Nozzle parameter — 
    you need to update all instances where the method VisionUtils.getBottomVisionCamera() is called and replace it with the new version that accepts a Nozzle parameter.
     */
    ...
    // Update the camera selection to include the Nozzle parameter
